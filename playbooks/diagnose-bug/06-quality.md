...
| Gate compliance | 15% | CL-DIAGNO pass + H-PLAN pending |
...
| AC-WR-01 | WR `artifacts[]` lists DIAG path | 100% |
...
**Handoff allowed:** CL-DIAGNO `result: pass` AND all required ACs pass.
