...
| IN-31 | `checklist` | `{ai_dev_os_home}/checklists/issue.md` |
| IN-32 | `self_spec` | `{ai_dev_os_home}/playbooks/draft-issue/` |
...
| IN-41 | `diagnose_artifact` | When linked in WR (soft) |
| IN-50 | `human_revise_notes` | H-PLAN revise |
| IN-51 | `prior_artifact` | Revise loop — prior ISS path |
...
| ID | Name | Destination |
|----|------|-------------|
| OUT-01 | ISS artifact | `{project_root}/work/issue/{work_id}.md` |
...
skill_id: PB-draft-issue
artifact_type: ISS
artifact_path: work/issue/{work_id}.md
