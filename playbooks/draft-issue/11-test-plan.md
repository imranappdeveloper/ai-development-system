...
| ENV-02 | `checklists/issue.md` — 10 items, `status: active` |
...
| ID | Input | Expected |
|----|-------|----------|
| HT-01 | Approved upstream + WF-BUGFIX | ISS complete; CL-ISSUE pass |
| HT-02 | Soft upstream linked | References populated; pass |
| HT-03 | H-PLAN revise | `revision: 1`; notes reflected |
| HT-04 | Golden fixture wf-bugfix-alpha | Matches ISSUE-bugfix-001.md structure |
| HT-05 | WR updated | `artifacts[]` lists ISS path |
...
| ET-03 | Code in ISS body | CL-ISSUE #5 fail |
| ET-04 | Missing upstream link | CL-ISSUE #3 fail |
| ET-05 | Agent `decision: approve` | CL-ISSUE #10 fail |
| ET-06 | Chat-only mode | Full artifact + `persist: pending` |
| ET-07 | Wrong workflow | EC-ENT block |
| ET-08 | Routing matrix embed | CL-ISSUE #5 fail |
...
| FT-04 | Golden ISSUE-bugfix-001.md | Structure valid |
...
```
HT: 100% AND ET(P0): 100% AND FT: 100% AND CL-ISSUE manual rubric pass AND 10-review ≥ 72
```
...
| CL-ISSUE rubric | pass |
| Golden ISSUE-bugfix-001.md | pass |
