...
| Gate compliance | 15% | CL-BOOTST pass + H-PLAN pending |
...
| AC-WR-01 | WR `artifacts[]` lists SCAFFOLD path | 100% |
...
**Handoff allowed:** CL-BOOTST `result: pass` AND all required ACs pass.
