...
3. **Launch Subagent**:
   ...
   - In the subagent prompt, instruct it to read and follow `$AI_DEV_OS_HOME/skills/tdd/SKILL.md` (Grok: `Read`; agy: `view_file` with `IsSkillFile: true` when the path is a skill symlink).
